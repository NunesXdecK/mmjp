...
interface SubjectMessageLayoutModalProps {
    title?: string,
    children?: any,
    isOpen?: boolean,
...
export default function SubjectMessageLayoutModal(props: SubjectMessageLayoutModalProps) {
    return (
                                ...
                                <Dialog.Panel className="pointer-events-auto relative w-screen max-w-md">
                                    ...
                                    >
                                        <div className="absolute top-0 left-0 -ml-8 flex pt-4 pr-2 sm:-ml-10 sm:pr-4">
                                            <button
                                                type="button"
                                                className="border-none rounded-md text-gray-300 hover:text-white focus:outline-none"
