...
export default function Button(props: ButtonProps) {
    ...
    if (props.isLight) {
        colorClassName = "bg-slate-50 hover:bg-gray-300 focus:ring-gray-300 dark:hover:bg-gray-600 dark:focus:ring-gray-600"
        ...
        className = "text-center h-min py-2 px-4 shadow-sm justify-center disabled:opacity-40 border border-transparent text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-50 dark:focus:ring-offset-slate-800"
    }
