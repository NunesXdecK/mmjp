    ...
    const handlePutHeaders = () => {
        return (
            <FormRow>
                ...
                <FormRowColumn unit="1" className="text-right">Valor</FormRowColumn>
                <FormRowColumn unit="1" className="text-right">Quantidade</FormRowColumn>
                <FormRowColumn unit="2" className="text-right">Total</FormRowColumn>
            </FormRow>
        )
    }
    ...
    const handlePutRows = (element: BudgetService) => {
        ...
        return (
            <FormRow>
                ...
                <FormRowColumn unit="1" className="text-right">{element.value}</FormRowColumn>
                <FormRowColumn unit="1" className="text-right">{element.quantity}</FormRowColumn>
                <FormRowColumn unit="2" className="text-right">{element.total}</FormRowColumn>
            </FormRow>
        )
    }
