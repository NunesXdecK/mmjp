...
export default function InputText(props: InputTextProps) {
    ...
    let classNameInputLocal = "peer p-2 mt-1 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
    classNameInputLocal = classNameInputLocal + " dark:text-gray-200 dark:bg-slate-800 dark:shadow-none dark:border-gray-700 dark:text-gray-200 dark:bg-slate-800 "
