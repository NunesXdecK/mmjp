...
export default function InputImmobilePoints(props: InputImmobilePointsProps) {
    ...
    const handleCopyTestText = (event) => {
        ...
        navigator.clipboard.writeText(JSON.stringify("BFBM5250,01/25/2012 10:51:59,Yes,yes,GPS/GLONASS,Static,Phase: fix all,L1 + L2,742950.2581,384858.5917,54.8052,0.0002,0.0002,0.0009"))
    }
